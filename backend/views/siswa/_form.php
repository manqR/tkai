    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-block">
                ...
                <?= $form->field($model, 'tanggal_lahir', ['options' => ['tag' => 'false']])->textInput(['class'=>'form-control m-b-1 datepicker','data-provide'=>'datepicker','style'=>'display: inline-block;width: 55%;position: absolute;height: 39px;right: 15px;top: 395px;'])->label(false) ?>   
